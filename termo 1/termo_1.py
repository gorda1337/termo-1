...
button1 = tk.Button(app, text= "Convertir a Celsius",command=covertir_a_celsius)
...
button2 = tk.Button(app, text= "Convertir a Fahrenheit", command=covertir_a_fahranheit)
